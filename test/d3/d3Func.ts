...
export const line = ({
  ...
  if (showSecondYAxis) {
    const maxY = typeof scaleY === 'number' ? scaleY : 400;
    const yScaleRight = d3.scaleLinear()
      .domain([0, maxY / yAxisScale])
      .rangeRound([height, 0]);
