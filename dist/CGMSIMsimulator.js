...
const simulator = ({ env, entries, treatments, profiles, pumpBasals }) => {
    ...
    const carbsActivity = carbs_1.default(treatments, carbsAbs);
    ...
    //activity calc carb
    const liver = liver_1.default(isf, cr);
    const newSgvValue = sgv_1.default(entries, { basalActivity, liver, carbsActivity, bolusActivity }, perls, isf);
    utils_1.default.info('this is the new sgv: %o', newSgvValue);
