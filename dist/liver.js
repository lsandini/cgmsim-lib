...
function default_1(isf, cr) {
    const _ISF = isf / 18;
    const _CR = cr;
    utils_1.default.info('ISF:', isf, 'CR:', cr);
    ...
    utils_1.default.info('sinus: ', sinus);
    utils_1.default.info('cosinus: ', cosinus);
    ...
    utils_1.default.info('liver: ', liver);
    utils_1.default.info('liver_sin: ', liver_sin);
    return liver_sin;
}
