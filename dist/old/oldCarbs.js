...
exports.oldCarbs = void 0;
const moment = require("moment");
const utils_1 = require("../src/utils");
const oldCarbs = (meal, carbAbsTime) => {
    const meals = meal.map(entry => (Object.assign(Object.assign({}, entry), { time: moment(entry.time).valueOf() })));
    const timeSinceMealMin = meals.map(entry => (Object.assign(Object.assign({}, entry), { mills: entry.time, time: (Date.now() - moment(entry.time).valueOf()) / (1000 * 60) })));
    utils_1.default.debug('this is the trimmed down meals and time since last meal:%o', timeSinceMealMin);
    ...
    let timeSinceMealAct = karbs.map(entry => {
        ...
        utils_1.default.debug('carbs_g:%o', carbs_g, 'fast:%o', fast, 'rest:%o', rest, 'fast_carbs:%o', fast_carbs, 'slow_carbs:%o', slow_carbs);
    ...
    utils_1.default.debug(totalCarbRate);
...
exports.oldCarbs = oldCarbs;
//# sourceMappingURL=oldCarbs.js.map