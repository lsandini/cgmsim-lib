...
import { PatientInput, StateDescription, TypedPatientState } from '../../types/Patient';
 ...
 *
 */
export class Jacobs2015 extends Cambridge {
...
export default createPatientFromODE<typeof stateDescription, typeof parameterDescription>(Jacobs2015);
