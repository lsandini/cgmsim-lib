...
export class UvaPadova_Visentin2015 extends UvaPadova_T1DMS implements ODEPatientModel<State> {
...
export default createPatientFromODE<typeof stateDescription, typeof parameterDescription>(UvaPadova_Visentin2015);
