	...
	implements ODEPatientModel<State>
{
	...
	computeDerivatives(t: Date, x: State, u: PatientInput): State {
		...
		if (tMeal > 0 && tMeal < params.Tasc) {
			...
			Gemp = Vmax - (Vmax / params.Tdes) * (tMeal - params.Tasc - params.Tmax);
		}
...
export default createPatientFromODE<typeof stateDescription, typeof parameterDescription>(RoyParker2007);
