 ...
 */
export default abstract class AbstractController<Parameters extends ParameterDescriptions>
	extends AbstractParametricModule<Parameters, typeof CommonControllerParametersDescription>
	implements Controller
{
	 ...
	 */
	abstract update(t: Date, s: TracedMeasurement, a?: AnnouncementList, m?: ControllerOutput): void;
