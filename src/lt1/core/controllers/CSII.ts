...
export default class CSII extends AbstractController<typeof CSIIParameters> implements Controller {
...
export const i18n_tooltip = {
	en: {
		basalRate:
			'Basal rate means the amount of insulin per time that is continuously administered. It is measured in units per hour (U/h).',
		inc_basal:
			'This is the difference between possible values of the basal rate. If it is greater than zero, the desired basal rate will be rounded.',
	},

	de: {
		basalRate:
			'Die Basalrate ist die kontinuierlich zugeführte Insulindosis pro Zeit. Sie wird in Einheiten pro Stunde (U/h) angegeben.',
		inc_basal:
			'Der Abstand zwischen benachbarten Werten, die die Basalrate annehmen kann. Ist er größer als null, wird die Basalrate gerundet.',
	},
};
