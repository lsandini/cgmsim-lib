 ...
 */
export default class MealBolusWithCorrection extends ControllerUnion implements Controller {
	constructor(parameters = {}) {
		super([new MealBolus(parameters), new CorrectionBolus(parameters)]);
	}
