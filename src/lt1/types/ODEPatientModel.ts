...
import { PatientState, StateDescription, PatientInput, PatientOutput } from './Patient';
 ...
 */
export default interface ODEPatientModel<State extends PatientState> extends ParametricModule {
	/**
