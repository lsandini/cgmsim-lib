...
import { AnnouncementList, ControllerOutput, Measurement, TracedMeasurement } from './Signals';
...
export default interface Controller extends IOModule {
	 ...
	 */
	update(t: Date, s: TracedMeasurement, a?: AnnouncementList, m?: ControllerOutput): void;
...
export { AnnouncementList, ControllerOutput, Measurement, TracedMeasurement } from './Signals';
