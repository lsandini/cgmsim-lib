...
export default function({ treatments, profiles, pumpBasals }, env) {
    ...
    logger.debug('\x1b[32m', '------------------pumpBasals %o', pumpBasals.length, '\x1b[0m');
    ...
    logger.debug('this is the aggregated insulin activity from pump basal in the last dia hours: %o', resultPumpAct);
