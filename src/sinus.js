...
module.exports = function() {
    ...
    logger.info('timestamp in milliseconds', Date.now());

    // timestamp in days;
    logger.info('timestamp in days', Date.now() / 86400000);

    // timestamp in days rounded;
    logger.info('timestamp in days rounded', Math.floor(Date.now() / 86400000));

    //timestamp in fraction of a day;
    logger.info('timestamp in fraction of a day', (Date.now() / 86400000) - (Math.floor(Date.now() / 86400000)));

    //fraction of a day in hours;
    logger.info('fraction of a day in hours', ((Date.now() / 86400000) - (Math.floor(Date.now() / 86400000))) * 24);

    //fraction of a day in hours adding 2 for UTC+2;
    logger.info('fraction of a day in hours adding 2 for UTC+2', (((Date.now() / 86400000) - (Math.floor(Date.now() / 86400000))) * 24) + 2);
